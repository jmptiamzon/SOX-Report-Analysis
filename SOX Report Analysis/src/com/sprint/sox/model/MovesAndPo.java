...
public class MovesAndPo {
	...
	public List<String> getTrxType() {
		return trxType;
	}

	public void setTrxType(String trxType) {
		this.trxType.add(trxType);
	}
	...
	public List<String> getTrxQty() {
		return trxQty;
	}

	public void setTrxQty(String trxQty) {
		this.trxQty.add(trxQty);
	}
